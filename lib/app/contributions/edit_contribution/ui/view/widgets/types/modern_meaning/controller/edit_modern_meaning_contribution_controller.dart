...
class EditModernMeaningContributionController
    extends EditContributionController {
  EditModernMeaningContributionController({
  ...
  void _setupSecondStep() {
    words.addAll((contribution as ModernMeaningContribution).modernMeanings);
