...
class EditPoemContributionController extends EditContributionController {
  EditPoemContributionController({
  ...
  void _setupSecondStep() {
    bodyController.text = (contribution as PoemContribution).body;
    descriptionController.text =
        (contribution as PoemContribution).description ?? '';
